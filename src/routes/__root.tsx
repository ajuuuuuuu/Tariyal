...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Tariyal Vanshawali" },
      { property: "og:description", content: "Explore the interactive family tree of the Umed family." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Tariyal Vanshawali" },
      { name: "twitter:description", content: "Explore the interactive family tree of the Umed family." },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <div className="flex h-screen flex-col overflow-hidden bg-[#faf7f2] dark:bg-[#0a1120]">
